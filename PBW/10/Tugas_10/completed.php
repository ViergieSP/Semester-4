              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    <form action="./src/todolist-update.php" method="POST">
                      ...
                      <button type="submit" class="btn btn-<?= $item['status'] === 'done' ? 'warning' : 'success' ?>">
                        <?= $item['status'] === 'done' ? 'Undone' : 'Done' ?>
                      </button>
                    </form>

                    <form action="./src/todolist-delete.php" onsubmit="return confirm('Yakin ingin menghapus?')" method="POST">
                      <input type="hidden" name="id" value="<?= $item["id"] ?>">
